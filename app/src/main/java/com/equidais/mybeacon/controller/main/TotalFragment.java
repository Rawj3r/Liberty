...
public class TotalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_total, container, false);

        visits_count = (TextView)view.findViewById(R.id.txt_visits);
    ...
    class GetVisits extends AsyncTask<String, String, JSONObject>{
        ...
        public final String DATA = "http://masscash.empirestate.co.za/gravity/getTotalData.php";
        ...
        protected JSONObject doInBackground(String... params) {
            ...
            try {
                ...
                if (object != null){
                    Log.e("MONTH RESULT", object.toString());
                    return object;
                }else {
